<?php
/**
 * Class WC_Payment_Token_anetcc file.
 * @author Bipin
 */
if (!defined('ABSPATH')) {
 ...
 */
class WC_Payment_Token_anetcc extends WC_Payment_Token {
    /**
     * Token Type String.
     *
     * @var string
     ...
     * @var array
     */
    public $extra_data = array('last4' => '', 'expiry_year' => '', 'expiry_month' => '', 'card_type' => '', 'customer_profile_id' => '');
    /**
    ...
    public function get_display_name($deprecated = '') {
        ...
        __('%1$s ending in %2$s (expires %3$s/%4$s)', 'woocommerce'), wc_get_credit_card_type_label($this->get_card_type()), $this->get_last4(), $this->get_expiry_month(), substr($this->get_expiry_year(), 2));
        return $display;
    }
    /**
     * Hook prefix
    ...
    public function get_hook_prefix() {
        return 'woocommerce_payment_token_anetcc_get_';
    }
    /**
    ...
    public function validate() {
        ...
        if (!$this->get_customer_profile_id('edit')) {
            return false;
        }
    ...
    public function get_customer_profile_id($context = 'view') {
        return $this->get_prop('customer_profile_id', $context);
    }
    public function set_customer_profile_id($customer_id) {
        $this->set_prop('customer_profile_id', $customer_id);
    }
}
