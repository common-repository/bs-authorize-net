...
$unseteledtrans = $report->anet_held_transactions();
...
$next = admin_url('admin.php').'?page=merchantdashboard&tab=fraudmanagement&limit='.$limit.'&offset='.($offset+1);
$prev = admin_url('admin.php').'?page=merchantdashboard&tab=fraudmanagement&limit='.$limit.'&offset='.($offset-1);
...
<form method="post" action="?page=merchantdashboard">
    <div class="tablenav top">
        ...
        <div class="alignright actions bulkactions">
            ...
            <?php if($offset>=$limit){ ?>
            <a href="<?php echo $prev; ?>" id="prevbtn" class="view-transactions transbtn-md left"><i class="fa fa-arrow-circle-left"></i>Load prev 2</a>
            <?php } if($hasdata && $unseteledtrans['total']>=$limit){ ?>
            <a href="<?php echo $next; ?>" id="nextbtn" class="view-transactions transbtn-md left">Load next 2<i class="fa fa-arrow-circle-right"></i></a>
            <?php } ?>
        </div>
